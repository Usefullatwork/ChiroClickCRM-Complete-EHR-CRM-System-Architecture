...
:: ============================================================
:: Train chiro-fast (Llama 3.2 3B) - Individual Model
:: Estimated: ~1 hour on RTX 2060
:: ============================================================
...
echo ============================================================
echo Training: chiro-fast (Llama 3.2 3B)
...
if not exist "%DATA_DIR%\quick-fields\train.jsonl" (
...
if exist "%DATA_DIR%\quick-fields\train.jsonl" (
    set "TRAIN_DATA=%DATA_DIR%\quick-fields"
) else (
...
:: Deploy to Ollama
if exist "%GGUF_DIR%\Modelfile.chiro-fast-lora" (
    echo Deploying to Ollama...
    pushd "%GGUF_DIR%"
    ollama create chiro-fast-lora -f Modelfile.chiro-fast-lora
    popd
)

echo.
echo ============================================================
echo chiro-fast COMPLETE: %date% %time%
echo Test: ollama run chiro-fast-lora "Generer hovedklage for nakkesmerter"
echo ============================================================
pause
exit /b 0
