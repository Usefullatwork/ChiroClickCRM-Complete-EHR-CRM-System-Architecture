    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Billing, payments, and revenue analytics</p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-yellow-800 mt-1">
                Total outstanding: {formatCurrency(outstanding.reduce((sum, inv) => sum + parseFloat(inv.patient_amount || 0), 0))}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600">{pagination.total} total transactions</p>
        </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        {transaction.insurance_amount > 0 && (
                          <div className="text-xs text-gray-500">
                            Insurance: {formatCurrency(transaction.insurance_amount)}
                          </div>
                        )}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-gray-600 mb-4">Transaction creation form coming soon...</p>
            <button
