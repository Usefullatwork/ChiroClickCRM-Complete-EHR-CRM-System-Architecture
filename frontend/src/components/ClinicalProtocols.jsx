      ...
      homeExercises: [
        {
          ...
          reps: '10',
          frequency: 'Daily',
          description: 'Lie on back with knees bent. Flatten low back to floor by tilting pelvis. Hold 5 seconds.'
        },
        {
          ...
          reps: '10',
          frequency: 'Daily',
          description: 'On hands and knees, alternate between arching and rounding spine. Move slowly and gently.'
        },
        {
          ...
          reps: '5 each side',
          frequency: 'Daily',
          description: 'Lie on back, pull one knee to chest. Hold 20-30 seconds. Keep other leg bent or straight.'
        },
        {
          name: 'Bird Dog',
          sets: '2',
          reps: '10 each side',
          frequency: 'Daily',
          description: 'On hands and knees, extend opposite arm and leg. Hold 5 seconds. Keep core engaged.'
        }
      ],
      expectedOutcomes: {
      ...
      homeExercises: [
        {
          ...
          reps: '10',
          frequency: '2x daily',
          description: 'Gently tuck chin straight back, creating double chin. Hold 5 seconds. Do NOT tilt head down.'
        },
        {
          ...
          reps: '2-3 minutes',
          frequency: 'As needed',
          description: 'Lie on back with tennis balls at base of skull. Relax and allow gentle pressure. Turn head side to side.'
        },
        {
          ...
          reps: '3 each side',
          frequency: '2x daily',
          description: 'Sit tall, tilt ear toward shoulder, gently pull head with hand. Hold 30 seconds. Avoid lifting shoulder.'
        },
        {
          ...
          reps: '5 each side',
          frequency: 'Daily',
          description: 'Turn head to look over shoulder. Gently pull chin toward armpit with hand. Hold 15 seconds.'
        }
      ],
      expectedOutcomes: {
      ...
      homeExercises: [
        {
          ...
          frequency: '2x daily',
          description: 'Bend forward, let arm hang. Swing arm gently in circles. Relax shoulder completely.'
        },
        {
          ...
          reps: '12-15',
          frequency: 'Daily',
          description: 'Elbow at 90°, band in hand. Rotate forearm outward keeping elbow at side. Slow and controlled.'
        },
        {
          name: 'Wall Slides',
          sets: '3',
          reps: '10',
          frequency: 'Daily',
          description: 'Stand against wall, slide arms overhead keeping contact with wall. Focus on scapular control.'
        },
        {
          ...
          reps: '15',
          frequency: 'Daily',
          description: 'Squeeze shoulder blades together. Hold 5 seconds. Keep shoulders down, away from ears.'
        }
      ],
      expectedOutcomes: {
      ...
      homeExercises: [
        {
          ...
          reps: '3 each side',
          frequency: '2x daily',
          description: 'Lie on back, cross ankle over opposite knee. Pull thigh toward chest. Hold 30 seconds.'
        },
        {
          ...
          reps: '3 each side',
          frequency: 'Daily',
          description: 'Seated, place ankle on opposite knee. Lean forward from hips. Hold 30 seconds.'
        },
        {
            ...
            {protocol.homeExercises.map((exercise, idx) => (
              <div key={idx} className="exercise-card">
                ...
                <div className="exercise-prescription">
                  <span className="ex-detail">{exercise.sets} sets × {exercise.reps}</span>
