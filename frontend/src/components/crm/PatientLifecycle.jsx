...
const PatientLifecycle = () => {
  ...
  const [patients] = useState([
    ...
    },
    {
      ...
      nextAppointment: '2026-01-17',
      totalVisits: 36,
      lifetimeValue: 43200,
      tags: ['VIP', 'Familie'],
      phone: '+47 989 01 234',
      email: 'sofie@example.no',
      referrals: 5,
      isVip: true
    }
  ]);
  ...
  const stageCounts = lifecycleStages.reduce((acc, stage) => {
