    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        {isLoading ? (
          ...
          <>
            {/* Table Header */}
            <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-3 bg-gray-50 border-b border-gray-200 text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">
                      ...
                      <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-12 md:col-span-4">
                          ...
                          {message.template_name && (
                            <span className="inline-flex items-center px-2 py-0.5 mt-1 text-xs bg-gray-100 text-gray-600 dark:text-gray-300 rounded">
                              {message.template_name}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="col-span-4 md:col-span-2">
                          ...
                          {message.is_automated && (
                            <span className="ml-1 text-xs text-gray-400 dark:text-gray-300">
                              ({t.automated})
                            </span>
                          )}
                        </div>
                        ...
                        <div className="col-span-4 md:col-span-2 flex items-center justify-between">
                          ...
                          <ChevronDown
                            className={`w-4 h-4 text-gray-400 dark:text-gray-300 transition-transform ${isExpanded ? 'rotate-180' : ''}`}
                          />
                        </div>
                      </div>
                    </div>
          ...
          <div className="px-6 py-12 text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t.noMessagesDesc}</p>
          </div>
        )}
      </div>
