...
export const ORTHO_EXAM_CLUSTERS = {
  ...
  CERVICAL_RADICULOPATHY: {
    ...
    name: {
      no: "Cervikal Radikulopati (Wainner's Cluster)",
      en: "Cervical Radiculopathy (Wainner's Cluster)",
    },
    region: 'CERVICAL',
    description: {
  ...
  ANKLE_SYNDESMOSE: {
    ...
    tests: [
      ...
      },
      {
        id: 'kleiger',
        name: {
          no: "Kleiger's Test (External Rotation)",
          en: "Kleiger's Test (External Rotation)",
        },
        procedure: {
  ...
  VASCULAR_LOWER: {
    id: 'VASCULAR_LOWER',
    name: {
      no: 'Vaskulær Undersøkelse (Underekstremitet)',
      en: 'Vascular Assessment (Lower Extremity)',
    },
    region: 'ANKLE_FOOT',
    description: {
  ...
  FUNCTIONAL_LOWER: {
    id: 'FUNCTIONAL_LOWER',
    name: {
      no: 'Funksjonell Testing (Underekstremitet)',
      en: 'Functional Testing (Lower Extremity)',
    },
    region: 'FUNCTIONAL',
    description: {
  ...
  FUNCTIONAL_UPPER: {
    id: 'FUNCTIONAL_UPPER',
    name: {
      no: 'Funksjonell Testing (Overekstremitet)',
      en: 'Functional Testing (Upper Extremity)',
    },
    region: 'FUNCTIONAL',
    description: {
  ...
  POSTURAL_SYNDROME: {
    ...
    name: {
      no: 'Posturalt Syndrom (Upper/Lower Cross)',
      en: 'Postural Syndrome (Upper/Lower Cross)',
    },
    region: 'THORACIC',
    description: {
  ...
  ADHESIVE_CAPSULITIS: {
    ...
    name: {
      no: 'Adhesiv Kapsulitt (Frozen Shoulder)',
      en: 'Adhesive Capsulitis (Frozen Shoulder)',
    },
    region: 'SHOULDER',
    description: {
    ...
    tests: [
      {
        ...
        name: {
          no: 'Kombinert Foot Drop + Plantarfleksjon Svakhet',
          en: 'Combined Foot Drop + Plantar Flexion Weakness',
        },
        procedure: {
  ...
  KIENBOCK_LUNATE: {
    id: 'KIENBOCK_LUNATE',
    name: {
      no: "Kienböck's Sykdom / Lunatum Patologi",
      en: "Kienböck's Disease / Lunate Pathology",
    },
    region: 'WRIST_HAND',
    description: {
