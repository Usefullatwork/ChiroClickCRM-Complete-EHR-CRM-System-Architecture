...
import { format, parseISO, isToday, differenceInMinutes, isSameDay } from 'date-fns'
      ...
      <div className="relative">
        {hours.slice(0, -1).map((hour) => (
          ...
          >
            ...
            {/* Half hour mark */}
            <span className="absolute top-[29px] right-2 text-[10px] text-gray-400">
              :30
            </span>
          </div>
        ))}
