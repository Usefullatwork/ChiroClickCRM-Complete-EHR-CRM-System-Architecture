      ...
      <div className="bg-white rounded-lg border border-gray-200">
        {workflowsLoading ? (
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 text-gray-400 dark:text-gray-300 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                        title={t.edit}
                      >
                      ...
                      <button
                        ...
                        className="p-2 text-gray-400 dark:text-gray-300 hover:text-purple-600 hover:bg-purple-50 rounded-lg transition-colors"
                        title={t.viewHistory}
                      >
                      ...
                      <button
                        ...
                        className="p-2 text-gray-400 dark:text-gray-300 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                        title={t.delete}
                      >
          ...
          <div className="px-6 py-12 text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{t.noWorkflowsDesc}</p>
            <button
              onClick={onCreateNew}
