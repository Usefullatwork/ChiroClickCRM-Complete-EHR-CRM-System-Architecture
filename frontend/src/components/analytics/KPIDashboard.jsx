    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Button variant="outline" size="sm" onClick={() => setShowEmailModal(true)} icon={Mail}>
            Email Report
          </Button>
          ...
          <Button
            ...
            onClick={() => {
              ...
              const data = [
                ...
                [
                  'Active Patients',
                  currentKPIs.activePatients,
                  `${trends.activePatients?.percent}%`,
                ],
              ];
      ...
      {viewMode === 'weekend' ? (
        ...
        <WeekendDifferentialAnalysis timeRange={timeRange} selectedDate={selectedDate} />
      ) : (
        /* Standard KPI View */
        <>
          {/* KPI Cards */}
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-3 border-t border-slate-200">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-teal-600">
                        {currentKPIs.retentionRate
                          ? `${currentKPIs.retentionRate.toFixed(1)}%`
                          : '0%'}
                      </span>
                    </div>
                  </div>
          ...
          {metrics && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <Card.Body>
                  <KPIChart data={metrics.visitTrends} type="line" color="#14b8a6" label="Visits" />
                </Card.Body>
              </Card>
