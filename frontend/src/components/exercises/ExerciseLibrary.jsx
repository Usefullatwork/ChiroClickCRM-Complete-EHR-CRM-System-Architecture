                  ...
                  <div className="flex items-center gap-2 mt-2 pt-2 border-t border-gray-100">
                    ...
                    {exercise.description && (
                      <button
                        ...
                        className="flex items-center gap-1 px-3 py-2 text-xs text-gray-600 dark:text-gray-300 bg-gray-50 rounded-lg hover:bg-gray-100 active:bg-gray-200 transition-colors min-h-[36px] touch-manipulation"
                      >
            ...
            {filteredExercises.map((exercise) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="hidden sm:flex items-center gap-3 mt-1 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div className="p-4 overflow-y-auto" style={{ maxHeight: isMobile ? '50vh' : '60vh' }}>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                ...
                {detailExercise.subcategory && (
                  <span className="px-3 py-1.5 bg-gray-100 text-gray-600 dark:text-gray-300 rounded-full text-sm">
                    {detailExercise.subcategory}
                  </span>
                )}
                <span
                  ...
                  <div className="grid grid-cols-3 gap-3 text-sm">
                    ...
                    {detailExercise.hold_seconds && (
                      <div className="flex flex-col items-center p-3 bg-gray-50 rounded-lg">
                        ...
                        <span className="text-xs text-gray-500 dark:text-gray-400">sek hold</span>
                      </div>
                    )}
                  </div>
                </div>
