...
function ShoulderDiagram({ width = 250, height = 200, side = 'both' }) {
  ...
  return (
    <g>
      ...
      />
      <text x={centerX} y={35} fontSize="8" fill="#6b7280" textAnchor="middle">Clavicula</text>
      ...
      {isLeft && (
        <g>
          ...
          <text x={centerX - 105} y={55} fontSize="6" fill="#9ca3af">AC</text>
        </g>
      )}
      ...
      {isRight && (
        <g>
          ...
          />
          <circle cx={centerX + 90} cy={62} r={4} fill="none" stroke="#d1d5db" strokeWidth="1" />
          <text x={centerX + 98} y={55} fontSize="6" fill="#9ca3af">AC</text>
        </g>
      )}
      ...
      {isLeft && (
        <g>
          ...
          <text x={centerX - 70} y={93} fontSize="7" fill="#6b7280" textAnchor="middle">Humerus</text>

          {/* Greater tuberosity */}
          <circle cx={centerX - 85} cy={80} r={6} fill="none" stroke="#d1d5db" strokeWidth="1" />
          <text x={centerX - 100} y={75} fontSize="5" fill="#9ca3af">GT</text>

          {/* Biceps groove */}
          <line x1={centerX - 70} y1={65} x2={centerX - 70} y2={80} stroke="#d1d5db" strokeWidth="1" />
        </g>
      )}
      ...
      {isRight && (
        <g>
          ...
          {/* Greater tuberosity */}
          <circle cx={centerX + 85} cy={80} r={6} fill="none" stroke="#d1d5db" strokeWidth="1" />
          <text x={centerX + 92} y={75} fontSize="5" fill="#9ca3af">GT</text>
      ...
      {isLeft && (
        <path
          d={`M ${centerX - 60} 60
              ...
              L ${centerX - 95} 80
              Z`}
          fill="none" stroke="#d1d5db" strokeWidth="1" strokeDasharray="3,2"
        />
      )}
      ...
      {/* Labels */}
      {isLeft && <text x={centerX - 70} y={height - 10} fontSize="10" fill="#6b7280" textAnchor="middle" fontWeight="bold">V / L</text>}
      {isRight && <text x={centerX + 70} y={height - 10} fontSize="10" fill="#6b7280" textAnchor="middle" fontWeight="bold">H / R</text>}
    </g>
  );
}
...
function KneeDiagram({ width = 200, height = 250, side = 'both' }) {
  ...
  const renderKnee = (x, label) => (
    <g>
      ...
      />
      <text x={x} y={50} fontSize="7" fill="#6b7280" textAnchor="middle">Femur</text>

      {/* Patella */}
      <ellipse cx={x} cy={125} rx={15} ry={18} fill="none" stroke="#9ca3af" strokeWidth="1.5" />
      <text x={x} y={128} fontSize="6" fill="#6b7280" textAnchor="middle">Patella</text>

      {/* Joint line */}
      <line x1={x - 25} y1={145} x2={x + 25} y2={145} stroke="#d1d5db" strokeWidth="1" strokeDasharray="4,2" />
      <text x={x + 30} y={148} fontSize="5" fill="#9ca3af">Leddlinje</text>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={x} y={200} fontSize="7" fill="#6b7280" textAnchor="middle">Tibia</text>

      {/* Fibula head */}
      <circle cx={x + 28} cy={160} r={6} fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={x + 38} y={163} fontSize="5" fill="#9ca3af">Fib</text>

      {/* Medial/Lateral meniscus indicators */}
      <path d={`M ${x - 18} 140 Q ${x - 10} 148, ${x - 2} 140`} fill="none" stroke="#10b981" strokeWidth="1.5" />
      <path d={`M ${x + 18} 140 Q ${x + 10} 148, ${x + 2} 140`} fill="none" stroke="#10b981" strokeWidth="1.5" />
      <text x={x - 25} y={135} fontSize="5" fill="#10b981">MM</text>
      <text x={x + 22} y={135} fontSize="5" fill="#10b981">LM</text>

      {/* MCL/LCL */}
      <line x1={x - 20} y1={120} x2={x - 22} y2={165} stroke="#3b82f6" strokeWidth="1.5" />
      <line x1={x + 20} y1={120} x2={x + 22} y2={165} stroke="#3b82f6" strokeWidth="1.5" />
      <text x={x - 32} y={145} fontSize="5" fill="#3b82f6">MCL</text>
      <text x={x + 26} y={145} fontSize="5" fill="#3b82f6">LCL</text>

      {/* Label */}
      <text x={x} y={height - 5} fontSize="10" fill="#6b7280" textAnchor="middle" fontWeight="bold">{label}</text>
    </g>
  );
 ...
 */
function CervicalSpineDiagram({ width = 200, height = 250 }) {
  const centerX = width / 2;
  ...
  return (
    <g>
      {/* Skull base */}
      <ellipse cx={centerX} cy={30} rx={40} ry={25} fill="none" stroke="#9ca3af" strokeWidth="1.5" />
      <text x={centerX} y={25} fontSize="7" fill="#6b7280" textAnchor="middle">Occiput</text>
      ...
      {vertebrae.map((v, i) => {
        ...
        return (
          <g key={v}>
            {/* Vertebral body */}
            <rect x={centerX - 15} y={y} width={30} height={18} rx={3}
              fill="none" stroke="#9ca3af" strokeWidth="1.5" />
            ...
            {i < 6 && (
              <ellipse cx={centerX} cy={y + 21} rx={12} ry={3}
                fill="#dbeafe" stroke="#93c5fd" strokeWidth="0.5" />
            )}

            {/* Label */}
            <text x={centerX - 25} y={y + 13} fontSize="8" fill="#6b7280" fontWeight="bold">{v}</text>

            {/* Nerve root */}
            <path
              d={`M ${centerX + 12} ${y + 5}
                  C ${centerX + 25} ${y + 5}, ${centerX + 35} ${y - 5}, ${centerX + 45} ${y - 10}`}
              fill="none" stroke="#fbbf24" strokeWidth="1.5" strokeOpacity="0.6"
            />
          </g>
        );
      })}
      ...
      {/* T1 reference */}
      <rect x={centerX - 18} y={235} width={36} height={12} rx={2}
        fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={centerX - 28} y={244} fontSize="7" fill="#9ca3af">T1</text>
    </g>
  );
}
 ...
 */
function LumbarSpineDiagram({ width = 200, height = 250 }) {
  const centerX = width / 2;
  ...
  return (
    <g>
      {/* T12 reference */}
      <rect x={centerX - 20} y={15} width={40} height={15} rx={3}
        fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={centerX - 30} y={26} fontSize="7" fill="#9ca3af">T12</text>
      ...
      {vertebrae.map((v, i) => {
        ...
        return (
          <g key={v}>
            {/* Vertebral body */}
            <rect x={centerX - 22} y={y} width={44} height={25} rx={4}
              fill="none" stroke="#9ca3af" strokeWidth="1.5" />

            {/* Spinous process */}
            <rect x={centerX - 4} y={y - 8} width={8} height={12} rx={2}
              fill="none" stroke="#d1d5db" strokeWidth="1" />

            {/* Transverse processes */}
            <line x1={centerX - 22} y1={y + 12} x2={centerX - 40} y2={y + 8}
            ...
            {/* Disc */}
            {i < 4 && (
              <ellipse cx={centerX} cy={y + 30} rx={18} ry={4}
                fill="#dbeafe" stroke="#93c5fd" strokeWidth="0.5" />
            )}

            {/* Label */}
            <text x={centerX} y={y + 16} fontSize="9" fill="#6b7280" textAnchor="middle" fontWeight="bold">{v}</text>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={centerX} y={235} fontSize="8" fill="#6b7280" textAnchor="middle">Sacrum</text>
    </g>
  );
}
...
function HipDiagram({ width = 250, height = 220, side = 'both' }) {
    ...
    return (
      <g>
        ...
        <path
          ...
          fill="none" stroke="#9ca3af" strokeWidth="1.5"
        />
        <text x={x + dir * 35} y={55} fontSize="7" fill="#6b7280">Ilium</text>

        {/* Acetabulum */}
        <circle cx={x + dir * 30} cy={100} r={22} fill="none" stroke="#9ca3af" strokeWidth="1.5" />
        <text x={x + dir * 30} y={103} fontSize="6" fill="#6b7280" textAnchor="middle">Acetab.</text>

        {/* Femoral head */}
        <circle cx={x + dir * 30} cy={100} r={18} fill="none" stroke="#d1d5db" strokeWidth="1" strokeDasharray="3,2" />
        ...
        {/* Greater trochanter */}
        <ellipse cx={x + dir * 60} cy={130} rx={10} ry={15}
          fill="none" stroke="#d1d5db" strokeWidth="1" />
        <text x={x + dir * 75} y={133} fontSize="5" fill="#9ca3af">GT</text>
        ...
        <text x={x + dir * 5} y={38} fontSize="5" fill="#ef4444">ASIS</text>

        {/* Label */}
        <text x={x + dir * 30} y={height - 5} fontSize="10" fill="#6b7280" textAnchor="middle" fontWeight="bold">{label}</text>
      </g>
    );
  };
  ...
  return (
    <g>
      {/* Pubic symphysis */}
      <rect x={centerX - 8} y={85} width={16} height={25} rx={3}
        fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={centerX} y={120} fontSize="6" fill="#9ca3af" textAnchor="middle">Symphysis</text>
  ...
  const renderAnkle = (x, label) => (
    <g>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={x} y={50} fontSize="7" fill="#6b7280" textAnchor="middle">Tibia</text>

      {/* Medial malleolus */}
      <ellipse cx={x - 18} cy={115} rx={8} ry={12}
        fill="none" stroke="#9ca3af" strokeWidth="1.5" />
      <text x={x - 30} y={118} fontSize="5" fill="#9ca3af">MM</text>

      {/* Lateral malleolus (fibula) */}
      <ellipse cx={x + 20} cy={118} rx={6} ry={14}
        fill="none" stroke="#9ca3af" strokeWidth="1.5" />
      <text x={x + 30} y={121} fontSize="5" fill="#9ca3af">LM</text>

      {/* Talus */}
      <ellipse cx={x} cy={125} rx={20} ry={12}
        fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={x} y={128} fontSize="6" fill="#6b7280" textAnchor="middle">Talus</text>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={x - 12} y={155} fontSize="6" fill="#6b7280">Calc.</text>
      ...
      />
      <text x={x - 18} y={105} fontSize="5" fill="#f97316">AT</text>

      {/* ATFL */}
      <line x1={x + 18} y1={110} x2={x + 25} y2={135}
        stroke="#3b82f6" strokeWidth="1.5" />
      <text x={x + 28} y={145} fontSize="5" fill="#3b82f6">ATFL</text>

      {/* CFL */}
      <line x1={x + 20} y1={120} x2={x + 10} y2={155}
        stroke="#3b82f6" strokeWidth="1.5" />
      <text x={x + 15} y={162} fontSize="5" fill="#3b82f6">CFL</text>
      ...
      />
      <text x={x - 35} y={140} fontSize="5" fill="#10b981">Delt.</text>
  ...
  const renderWrist = (x, label) => (
    <g>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={x - 12} y={40} fontSize="6" fill="#6b7280">Radius</text>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={x + 12} y={40} fontSize="6" fill="#6b7280">Ulna</text>

      {/* Ulnar styloid */}
      <circle cx={x + 18} cy={72} r={4} fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={x + 25} y={75} fontSize="5" fill="#9ca3af">US</text>

      {/* Radial styloid */}
      <circle cx={x - 18} cy={78} r={4} fill="none" stroke="#d1d5db" strokeWidth="1" />
      <text x={x - 28} y={81} fontSize="5" fill="#9ca3af">RS</text>

      {/* Carpals */}
      <rect x={x - 22} y={82} width={44} height={25} rx={5}
        fill="none" stroke="#9ca3af" strokeWidth="1.5" />
      <text x={x} y={97} fontSize="6" fill="#6b7280" textAnchor="middle">Carpalia</text>

      {/* Scaphoid */}
      <ellipse cx={x - 12} cy={90} rx={8} ry={6} fill="none" stroke="#d1d5db" strokeWidth="0.8" />
      <text x={x - 12} y={92} fontSize="4" fill="#9ca3af" textAnchor="middle">Sc</text>

      {/* Lunate */}
      <ellipse cx={x + 2} cy={88} rx={7} ry={5} fill="none" stroke="#d1d5db" strokeWidth="0.8" />
      <text x={x + 2} y={90} fontSize="4" fill="#9ca3af" textAnchor="middle">Lu</text>

      {/* Triquetrum */}
      <ellipse cx={x + 14} cy={90} rx={6} ry={5} fill="none" stroke="#d1d5db" strokeWidth="0.8" />
      <text x={x + 14} y={92} fontSize="4" fill="#9ca3af" textAnchor="middle">Tri</text>
      ...
      {[...Array(5)].map((_, i) => {
        ...
        return (
          <g key={i}>
            <rect x={mcX - 3} y={108} width={7} height={30} rx={2}
              fill="none" stroke="#d1d5db" strokeWidth="1" />
            <text x={mcX} y={125} fontSize="5" fill="#9ca3af" textAnchor="middle">M{i + 1}</text>
          </g>
        );
      })}
      ...
      {[...Array(5)].map((_, i) => {
        ...
        return (
          <line key={i} x1={fX} y1={140} x2={fX} y2={140 + fLen}
            stroke="#d1d5db" strokeWidth="4" strokeLinecap="round" />
        );
      })}

      {/* TFCC */}
      <ellipse cx={x + 10} cy={80} rx={8} ry={4}
        fill="#dbeafe" stroke="#93c5fd" strokeWidth="0.5" />
      <text x={x + 22} y={82} fontSize="5" fill="#3b82f6">TFCC</text>
  ...
  const renderElbow = (x, label) => (
    <g>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={x} y={45} fontSize="7" fill="#6b7280" textAnchor="middle">Humerus</text>

      {/* Lateral epicondyle */}
      <circle cx={x + 18} cy={95} r={6} fill="none" stroke="#ef4444" strokeWidth="1.5" />
      <text x={x + 28} y={98} fontSize="5" fill="#ef4444">LE</text>

      {/* Medial epicondyle */}
      <circle cx={x - 18} cy={95} r={6} fill="none" stroke="#ef4444" strokeWidth="1.5" />
      <text x={x - 30} y={98} fontSize="5" fill="#ef4444">ME</text>

      {/* Olecranon */}
      <ellipse cx={x} cy={115} rx={12} ry={8}
        fill="none" stroke="#9ca3af" strokeWidth="1.5" />
      <text x={x} y={118} fontSize="5" fill="#6b7280" textAnchor="middle">Olec.</text>

      {/* Radius */}
      <path
        d={`M ${x + 8} 115
            L ${x + 12} 200`}
        fill="none" stroke="#9ca3af" strokeWidth="6" strokeLinecap="round"
      />
      <text x={x + 22} y={160} fontSize="6" fill="#6b7280">Radius</text>
      ...
      <path
        d={`M ${x - 5} 120
            L ${x - 8} 200`}
        fill="none" stroke="#9ca3af" strokeWidth="5" strokeLinecap="round"
      />
      <text x={x - 18} y={160} fontSize="6" fill="#6b7280">Ulna</text>
      ...
      />
      <text x={x + 28} y={125} fontSize="5" fill="#f97316">CEO</text>
...
function HeadTMJDiagram({ width = 200, height = 200 }) {
  ...
  return (
    <g>
      ...
      <ellipse cx={centerX} cy={80} rx={60} ry={70} fill="none" stroke="#9ca3af" strokeWidth="1.5" />

      {/* TMJ - Left */}
      <circle cx={centerX - 55} cy={85} r={8} fill="none" stroke="#ef4444" strokeWidth="1.5" />
      <text x={centerX - 75} y={88} fontSize="6" fill="#ef4444">TMJ</text>

      {/* TMJ - Right */}
      <circle cx={centerX + 55} cy={85} r={8} fill="none" stroke="#ef4444" strokeWidth="1.5" />
      <text x={centerX + 65} y={88} fontSize="6" fill="#ef4444">TMJ</text>
      ...
      <path
        ...
        fill="none" stroke="#9ca3af" strokeWidth="1.5"
      />
      <text x={centerX} y={135} fontSize="7" fill="#6b7280" textAnchor="middle">Mandibula</text>

      {/* Mastoid processes */}
      <ellipse cx={centerX - 60} cy={105} rx={5} ry={8} fill="none" stroke="#d1d5db" strokeWidth="1" />
      <ellipse cx={centerX + 60} cy={105} rx={5} ry={8} fill="none" stroke="#d1d5db" strokeWidth="1" />
      ...
      <path
        ...
        fill="none" stroke="#d1d5db" strokeWidth="1" strokeDasharray="3,2"
      />
      <text x={centerX - 35} y={55} fontSize="6" fill="#9ca3af">Temporal</text>
      <text x={centerX + 20} y={55} fontSize="6" fill="#9ca3af">Temporal</text>
      ...
      <path
        ...
        fill="none" stroke="#d1d5db" strokeWidth="1"
      />
      <text x={centerX} y={8} fontSize="6" fill="#9ca3af" textAnchor="middle">Suboccipital</text>

      {/* Labels */}
      <text x={centerX - 50} y={height - 5} fontSize="9" fill="#6b7280" fontWeight="bold">V / L</text>
      <text x={centerX + 35} y={height - 5} fontSize="9" fill="#6b7280" fontWeight="bold">H / R</text>
    </g>
  );
}
...
function DiagramMarker({ marker, onRemove, selected, onSelect }) {
  ...
  return (
    ...
    >
      <circle
        cx={marker.x} cy={marker.y} r={size}
        fill={type.color} fillOpacity={0.3}
        stroke={type.color} strokeWidth={selected ? 2 : 1}
      />
      <text
        x={marker.x} y={marker.y + 4}
        fontSize="10" fontWeight="bold" fill={type.color} textAnchor="middle"
      >
        {type.symbol}
      </text>
      {selected && (
...
export default function RegionalBodyDiagram({
  ...
  const configs = {
    shoulder: { width: 250, height: 200, Component: ShoulderDiagram, title: 'Skulder', titleEn: 'Shoulder' },
    ...
    wrist: { width: 220, height: 220, Component: WristDiagram, title: 'Håndledd', titleEn: 'Wrist' },
    elbow: { width: 200, height: 220, Component: ElbowDiagram, title: 'Albue', titleEn: 'Elbow' },
    cervical: { width: 200, height: 250, Component: CervicalSpineDiagram, title: 'Cervikalkolumna', titleEn: 'Cervical Spine' },
    lumbar: { width: 200, height: 250, Component: LumbarSpineDiagram, title: 'Lumbalkolumna', titleEn: 'Lumbar Spine' },
    hip: { width: 250, height: 220, Component: HipDiagram, title: 'Hofte', titleEn: 'Hip' },
    head: { width: 200, height: 200, Component: HeadTMJDiagram, title: 'Hode/TMJ', titleEn: 'Head/TMJ' },
  };
    ...
    <div className={`flex ${compact ? 'gap-2' : 'gap-4 flex-col md:flex-row'}`}>
      ...
      <div className={compact ? 'w-24 space-y-2' : 'w-full md:w-40 space-y-3'}>
        ...
        {markers.length > 0 && !readOnly && (
          <button
            onClick={() => { onChange([]); setSelectedMarker(null); }}
