...
export const QUESTIONNAIRES = {
  ...
  RMDQ: {
    ...
    type: 'checklist',
    sections: [
      { id: 'rmdq1', text: { en: 'I stay at home most of the time because of my back', no: 'Jeg er hjemme det meste av tiden på grunn av ryggen' } },
      { id: 'rmdq2', text: { en: 'I change position frequently to try and get my back comfortable', no: 'Jeg skifter stilling ofte for å prøve å få ryggen komfortabel' } },
      { id: 'rmdq3', text: { en: 'I walk more slowly than usual because of my back', no: 'Jeg går saktere enn vanlig på grunn av ryggen' } },
      { id: 'rmdq4', text: { en: 'Because of my back, I am not doing any of the jobs that I usually do around the house', no: 'På grunn av ryggen gjør jeg ikke noe av husarbeidet jeg vanligvis gjør' } },
      { id: 'rmdq5', text: { en: 'Because of my back, I use a handrail to get upstairs', no: 'På grunn av ryggen bruker jeg gelender for å gå opp trappen' } },
      { id: 'rmdq6', text: { en: 'Because of my back, I lie down to rest more often', no: 'På grunn av ryggen legger jeg meg ned for å hvile oftere' } },
      { id: 'rmdq7', text: { en: 'Because of my back, I have to hold on to something to get out of an easy chair', no: 'På grunn av ryggen må jeg holde meg i noe for å reise meg fra en lenestol' } },
      { id: 'rmdq8', text: { en: 'Because of my back, I try to get other people to do things for me', no: 'På grunn av ryggen prøver jeg å få andre til å gjøre ting for meg' } },
      { id: 'rmdq9', text: { en: 'I get dressed more slowly than usual because of my back', no: 'Jeg kler på meg saktere enn vanlig på grunn av ryggen' } },
      { id: 'rmdq10', text: { en: 'I only stand for short periods of time because of my back', no: 'Jeg står bare korte perioder om gangen på grunn av ryggen' } },
      { id: 'rmdq11', text: { en: 'Because of my back, I try not to bend or kneel down', no: 'På grunn av ryggen prøver jeg å ikke bøye meg eller knele' } },
      { id: 'rmdq12', text: { en: 'I find it difficult to get out of a chair because of my back', no: 'Jeg synes det er vanskelig å reise meg fra en stol på grunn av ryggen' } },
      { id: 'rmdq13', text: { en: 'My back is painful almost all the time', no: 'Ryggen min er smertefull nesten hele tiden' } },
      { id: 'rmdq14', text: { en: 'I find it difficult to turn over in bed because of my back', no: 'Jeg synes det er vanskelig å snu meg i sengen på grunn av ryggen' } },
      { id: 'rmdq15', text: { en: 'My appetite is not very good because of my back pain', no: 'Appetitten min er ikke så god på grunn av ryggsmertene' } },
      { id: 'rmdq16', text: { en: 'I have trouble putting on my socks (or stockings) because of the pain in my back', no: 'Jeg har problemer med å ta på meg sokker på grunn av smerter i ryggen' } },
      { id: 'rmdq17', text: { en: 'I only walk short distances because of my back pain', no: 'Jeg går bare korte avstander på grunn av ryggsmertene' } },
      { id: 'rmdq18', text: { en: 'I sleep less well because of my back', no: 'Jeg sover dårligere på grunn av ryggen' } },
      { id: 'rmdq19', text: { en: 'Because of my back pain, I get dressed with help from someone else', no: 'På grunn av ryggsmertene kler jeg på meg med hjelp fra noen andre' } },
      { id: 'rmdq20', text: { en: 'I sit down for most of the day because of my back', no: 'Jeg sitter det meste av dagen på grunn av ryggen' } },
      { id: 'rmdq21', text: { en: 'I avoid heavy jobs around the house because of my back', no: 'Jeg unngår tunge oppgaver i hjemmet på grunn av ryggen' } },
      { id: 'rmdq22', text: { en: 'Because of my back pain, I am more irritable and bad tempered with people than usual', no: 'På grunn av ryggsmertene er jeg mer irritabel og i dårlig humør overfor andre enn vanlig' } },
      { id: 'rmdq23', text: { en: 'Because of my back, I go upstairs more slowly than usual', no: 'På grunn av ryggen går jeg opp trappen saktere enn vanlig' } },
      { id: 'rmdq24', text: { en: 'I stay in bed most of the time because of my back', no: 'Jeg ligger i sengen det meste av tiden på grunn av ryggen' } },
    ],
    scoring: {
      maxScore: 24,
      interpretation: [
        { min: 0, max: 4, level: 'minimal', label: { en: 'Minimal Disability', no: 'Minimal funksjonsnedsettelse' }, color: 'green' },
        { min: 5, max: 9, level: 'mild', label: { en: 'Mild Disability', no: 'Mild funksjonsnedsettelse' }, color: 'yellow' },
        { min: 10, max: 14, level: 'moderate', label: { en: 'Moderate Disability', no: 'Moderat funksjonsnedsettelse' }, color: 'orange' },
        { min: 15, max: 19, level: 'severe', label: { en: 'Severe Disability', no: 'Alvorlig funksjonsnedsettelse' }, color: 'red' },
        { min: 20, max: 24, level: 'very_severe', label: { en: 'Very Severe Disability', no: 'Svært alvorlig funksjonsnedsettelse' }, color: 'darkred' },
      ],
      mcid: 5, // Minimal Clinically Important Difference
    },
  },
  ...
  STARTBACK: {
    ...
    sections: [
      ...
      { id: 'start1', text: { en: 'My back pain has spread down my leg(s) at some time in the last 2 weeks', no: 'Ryggsmertene mine har spredt seg ned i beinet/beinene mine i løpet av de siste 2 ukene' }, domain: 'physical' },
      { id: 'start2', text: { en: 'I have had pain in the shoulder or neck at some time in the last 2 weeks', no: 'Jeg har hatt smerter i skulder eller nakke i løpet av de siste 2 ukene' }, domain: 'physical' },
      { id: 'start3', text: { en: 'I have only walked short distances because of my back pain', no: 'Jeg har bare gått korte avstander på grunn av ryggsmertene mine' }, domain: 'physical' },
      { id: 'start4', text: { en: 'In the last 2 weeks, I have dressed more slowly than usual because of back pain', no: 'I de siste 2 ukene har jeg kledd på meg saktere enn vanlig på grunn av ryggsmerter' }, domain: 'physical' },
      // Items 5-9: Psychosocial domain + Total score
      { id: 'start5', text: { en: 'It\'s not really safe for a person with a condition like mine to be physically active', no: 'Det er egentlig ikke trygt for en person med en tilstand som min å være fysisk aktiv' }, domain: 'psychosocial' },
      { id: 'start6', text: { en: 'Worrying thoughts have been going through my mind a lot of the time', no: 'Bekymringsfulle tanker har gått gjennom hodet mitt mye av tiden' }, domain: 'psychosocial' },
      { id: 'start7', text: { en: 'I feel that my back pain is terrible and it\'s never going to get any better', no: 'Jeg føler at ryggsmertene mine er forferdelige og at det aldri kommer til å bli bedre' }, domain: 'psychosocial' },
      { id: 'start8', text: { en: 'In general I have not enjoyed all the things I used to enjoy', no: 'Generelt har jeg ikke nytt alle tingene jeg pleide å nyte' }, domain: 'psychosocial' },
    ],
    // Item 9 is a special 5-point scale
    specialItems: [
      {
        id: 'start9',
        text: { en: 'Overall, how bothersome has your back pain been in the last 2 weeks?', no: 'Totalt sett, hvor plagsom har ryggsmertene dine vært de siste 2 ukene?' },
        domain: 'psychosocial',
        options: [
    ...
    scoring: {
      ...
      interpretation: [
        { min: 0, max: 3, psychMin: 0, psychMax: 3, level: 'low', label: { en: 'Low Risk', no: 'Lav risiko' }, color: 'green', recommendation: { en: 'Reassurance, advice, simple analgesia', no: 'Betryggende informasjon, råd, enkel smertelindring' } },
        { min: 4, max: 9, psychMin: 0, psychMax: 3, level: 'medium', label: { en: 'Medium Risk', no: 'Middels risiko' }, color: 'yellow', recommendation: { en: 'Physiotherapy with focus on physical symptoms', no: 'Fysioterapi med fokus på fysiske symptomer' } },
        { min: 4, max: 9, psychMin: 4, psychMax: 5, level: 'high', label: { en: 'High Risk', no: 'Høy risiko' }, color: 'red', recommendation: { en: 'Physiotherapy addressing psychosocial factors', no: 'Fysioterapi som adresserer psykososiale faktorer' } },
      ],
      mcid: 2,
    },
  },
  ...
  BQ: {
    ...
    sections: [
      {
        id: 'bq1',
        title: { en: 'Pain Intensity', no: 'Smerteintensitet' },
        question: { en: 'Over the past week, on average, how would you rate your back/neck pain?', no: 'I løpet av den siste uken, i gjennomsnitt, hvordan vil du vurdere rygg/nakke-smertene dine?' },
      ...
      },
      {
        ...
        question: { en: 'Over the past week, how much has your back/neck pain interfered with your daily activities (housework, washing, dressing, lifting, reading, driving)?', no: 'I løpet av den siste uken, hvor mye har rygg/nakke-smertene dine påvirket dine daglige aktiviteter (husarbeid, vask, påkledning, løfting, lesing, bilkjøring)?' },
        leftLabel: { en: 'No interference', no: 'Ingen påvirkning' },
        rightLabel: { en: 'Unable to carry out activities', no: 'Ute av stand til å utføre aktiviteter' },
      },
      {
        id: 'bq3',
        title: { en: 'Social Activities', no: 'Sosiale aktiviteter' },
        question: { en: 'Over the past week, how much has your back/neck pain interfered with your ability to take part in recreational, social and family activities?', no: 'I løpet av den siste uken, hvor mye har rygg/nakke-smertene dine påvirket din evne til å delta i fritids-, sosiale- og familieaktiviteter?' },
        leftLabel: { en: 'No interference', no: 'Ingen påvirkning' },
        rightLabel: { en: 'Unable to carry out activities', no: 'Ute av stand til å utføre aktiviteter' },
      },
      {
        ...
        question: { en: 'Over the past week, how anxious (tense, uptight, irritable, difficulty concentrating/relaxing) have you been feeling?', no: 'I løpet av den siste uken, hvor engstelig (anspent, oppjaget, irritabel, vanskeligheter med å konsentrere seg/slappe av) har du følt deg?' },
      ...
      },
      {
        ...
        question: { en: 'Over the past week, how depressed (down-in-the-dumps, sad, in low spirits, pessimistic, unhappy) have you been feeling?', no: 'I løpet av den siste uken, hvor deprimert (nedstemt, trist, i lavt humør, pessimistisk, ulykkelig) har du følt deg?' },
      ...
      },
      {
        ...
        question: { en: 'Over the past week, how much have you felt that your work (both inside and outside the home) has affected (or would affect) your back/neck pain?', no: 'I løpet av den siste uken, hvor mye har du følt at arbeidet ditt (både inne og utenfor hjemmet) har påvirket (eller ville påvirke) rygg/nakke-smertene dine?' },
      ...
      },
      {
        ...
        question: { en: 'Over the past week, how much have you been able to control (reduce/help) your back/neck pain on your own?', no: 'I løpet av den siste uken, hvor mye har du vært i stand til å kontrollere (redusere/hjelpe) rygg/nakke-smertene dine på egen hånd?' },
    ...
    scoring: {
      ...
      interpretation: [
        { min: 0, max: 14, level: 'minimal', label: { en: 'Minimal Impact', no: 'Minimal påvirkning' }, color: 'green' },
        { min: 15, max: 28, level: 'mild', label: { en: 'Mild Impact', no: 'Mild påvirkning' }, color: 'yellow' },
        { min: 29, max: 42, level: 'moderate', label: { en: 'Moderate Impact', no: 'Moderat påvirkning' }, color: 'orange' },
        { min: 43, max: 56, level: 'severe', label: { en: 'Severe Impact', no: 'Alvorlig påvirkning' }, color: 'red' },
        { min: 57, max: 70, level: 'very_severe', label: { en: 'Very Severe Impact', no: 'Svært alvorlig påvirkning' }, color: 'darkred' },
      ],
  ...
  DASH: {
    id: 'DASH',
    name: { en: 'Disabilities of Arm, Shoulder and Hand', no: 'Funksjonshemming i Arm, Skulder og Hånd' },
    shortName: 'DASH',
    description: {
    ...
    sections: [
      // Activities (1-21)
      { id: 'dash1', text: { en: 'Open a tight or new jar', no: 'Åpne et stramt eller nytt glass' }, category: 'activities' },
      ...
      { id: 'dash5', text: { en: 'Push open a heavy door', no: 'Skyve opp en tung dør' }, category: 'activities' },
      { id: 'dash6', text: { en: 'Place an object on a shelf above your head', no: 'Plassere en gjenstand på en hylle over hodet' }, category: 'activities' },
      { id: 'dash7', text: { en: 'Do heavy household chores (e.g., wash walls, floors)', no: 'Gjøre tunge husarbeidsoppgaver (f.eks. vaske vegger, gulv)' }, category: 'activities' },
      { id: 'dash8', text: { en: 'Garden or do yard work', no: 'Hagearbeid eller arbeid i hagen' }, category: 'activities' },
      { id: 'dash9', text: { en: 'Make a bed', no: 'Re opp en seng' }, category: 'activities' },
      { id: 'dash10', text: { en: 'Carry a shopping bag or briefcase', no: 'Bære en handlepose eller dokumentmappe' }, category: 'activities' },
      { id: 'dash11', text: { en: 'Carry a heavy object (over 5 kg)', no: 'Bære en tung gjenstand (over 5 kg)' }, category: 'activities' },
      { id: 'dash12', text: { en: 'Change a lightbulb overhead', no: 'Skifte en lyspære over hodet' }, category: 'activities' },
      { id: 'dash13', text: { en: 'Wash or blow dry your hair', no: 'Vaske eller føne håret' }, category: 'activities' },
      { id: 'dash14', text: { en: 'Wash your back', no: 'Vaske ryggen' }, category: 'activities' },
      { id: 'dash15', text: { en: 'Put on a pullover sweater', no: 'Ta på en genser' }, category: 'activities' },
      { id: 'dash16', text: { en: 'Use a knife to cut food', no: 'Bruke en kniv til å skjære mat' }, category: 'activities' },
      { id: 'dash17', text: { en: 'Recreational activities requiring little effort (e.g., cardplaying)', no: 'Fritidsaktiviteter som krever liten innsats (f.eks. kortspill)' }, category: 'activities' },
      { id: 'dash18', text: { en: 'Recreational activities with force/impact (e.g., golf, hammering, tennis)', no: 'Fritidsaktiviteter med kraft/støt (f.eks. golf, hamring, tennis)' }, category: 'activities' },
      { id: 'dash19', text: { en: 'Recreational activities with free arm movement (e.g., frisbee, badminton)', no: 'Fritidsaktiviteter med fri armbevegelse (f.eks. frisbee, badminton)' }, category: 'activities' },
      { id: 'dash20', text: { en: 'Manage transportation needs (getting from one place to another)', no: 'Håndtere transportbehov (komme seg fra ett sted til et annet)' }, category: 'activities' },
      { id: 'dash21', text: { en: 'Sexual activities', no: 'Seksuelle aktiviteter' }, category: 'activities', optional: true },
      // Social/Role (22-23)
      { id: 'dash22', text: { en: 'During the past week, to what extent has your arm, shoulder or hand problem interfered with your normal social activities with family, friends, neighbors or groups?', no: 'I løpet av den siste uken, i hvilken grad har ditt arm-, skulder- eller håndproblem påvirket dine normale sosiale aktiviteter med familie, venner, naboer eller grupper?' }, category: 'social' },
      { id: 'dash23', text: { en: 'During the past week, were you limited in your work or other regular daily activities as a result of your arm, shoulder or hand problem?', no: 'I løpet av den siste uken, var du begrenset i arbeidet ditt eller andre daglige aktiviteter som følge av ditt arm-, skulder- eller håndproblem?' }, category: 'social' },
      // Symptoms (24-29)
      { id: 'dash24', text: { en: 'Arm, shoulder or hand pain', no: 'Smerter i arm, skulder eller hånd' }, category: 'symptoms' },
      { id: 'dash25', text: { en: 'Arm, shoulder or hand pain when performing any specific activity', no: 'Smerter i arm, skulder eller hånd ved utførelse av en spesifikk aktivitet' }, category: 'symptoms' },
      { id: 'dash26', text: { en: 'Tingling (pins and needles) in your arm, shoulder or hand', no: 'Prikking (stikking) i arm, skulder eller hånd' }, category: 'symptoms' },
      { id: 'dash27', text: { en: 'Weakness in your arm, shoulder or hand', no: 'Svakhet i arm, skulder eller hånd' }, category: 'symptoms' },
      { id: 'dash28', text: { en: 'Stiffness in your arm, shoulder or hand', no: 'Stivhet i arm, skulder eller hånd' }, category: 'symptoms' },
      // Sleep (29-30)
      { id: 'dash29', text: { en: 'During the past week, how much difficulty have you had sleeping because of the pain in your arm, shoulder or hand?', no: 'I løpet av den siste uken, hvor mye vanskeligheter har du hatt med å sove på grunn av smerter i arm, skulder eller hånd?' }, category: 'sleep' },
      { id: 'dash30', text: { en: 'I feel less capable, less confident or less useful because of my arm, shoulder or hand problem', no: 'Jeg føler meg mindre kapabel, mindre selvsikker eller mindre nyttig på grunn av mitt arm-, skulder- eller håndproblem' }, category: 'confidence' },
    ],
    options: [
    ...
    scoring: {
      ...
      maxScore: 100,
      interpretation: [
        { min: 0, max: 20, level: 'minimal', label: { en: 'Minimal Disability', no: 'Minimal funksjonsnedsettelse' }, color: 'green' },
        { min: 21, max: 40, level: 'mild', label: { en: 'Mild Disability', no: 'Mild funksjonsnedsettelse' }, color: 'yellow' },
        { min: 41, max: 60, level: 'moderate', label: { en: 'Moderate Disability', no: 'Moderat funksjonsnedsettelse' }, color: 'orange' },
        { min: 61, max: 80, level: 'severe', label: { en: 'Severe Disability', no: 'Alvorlig funksjonsnedsettelse' }, color: 'red' },
        { min: 81, max: 100, level: 'very_severe', label: { en: 'Very Severe Disability', no: 'Svært alvorlig funksjonsnedsettelse' }, color: 'darkred' },
      ],
  ...
  HIT6: {
    ...
    sections: [
      {
        id: 'hit1',
        text: { en: 'When you have headaches, how often is the pain severe?', no: 'Når du har hodepine, hvor ofte er smerten sterk?' },
      },
      {
        id: 'hit2',
        text: { en: 'How often do headaches limit your ability to do usual daily activities including household work, work, school, or social activities?', no: 'Hvor ofte begrenser hodepine din evne til å gjøre vanlige daglige aktiviteter inkludert husarbeid, arbeid, skole eller sosiale aktiviteter?' },
      },
      {
        id: 'hit3',
        text: { en: 'When you have a headache, how often do you wish you could lie down?', no: 'Når du har hodepine, hvor ofte ønsker du at du kunne legge deg ned?' },
      },
      {
        id: 'hit4',
        text: { en: 'In the past 4 weeks, how often have you felt too tired to do work or daily activities because of your headaches?', no: 'I løpet av de siste 4 ukene, hvor ofte har du følt deg for sliten til å gjøre arbeid eller daglige aktiviteter på grunn av hodepinen din?' },
      },
      {
        id: 'hit5',
        text: { en: 'In the past 4 weeks, how often have you felt fed up or irritated because of your headaches?', no: 'I løpet av de siste 4 ukene, hvor ofte har du følt deg lei eller irritert på grunn av hodepinen din?' },
      },
      {
        id: 'hit6',
        text: { en: 'In the past 4 weeks, how often did headaches limit your ability to concentrate on work or daily activities?', no: 'I løpet av de siste 4 ukene, hvor ofte begrenset hodepine din evne til å konsentrere deg om arbeid eller daglige aktiviteter?' },
      },
    ],
    options: [
    ...
    scoring: {
      ...
      interpretation: [
        { min: 36, max: 49, level: 'little', label: { en: 'Little or No Impact', no: 'Liten eller ingen påvirkning' }, color: 'green' },
        { min: 50, max: 55, level: 'some', label: { en: 'Some Impact', no: 'Noe påvirkning' }, color: 'yellow' },
        { min: 56, max: 59, level: 'substantial', label: { en: 'Substantial Impact', no: 'Betydelig påvirkning' }, color: 'orange' },
        { min: 60, max: 78, level: 'severe', label: { en: 'Severe Impact', no: 'Alvorlig påvirkning' }, color: 'red' },
      ],
  ...
  QBPDS: {
    ...
    sections: [
      ...
      { id: 'qbpds6', text: { en: 'Sit in a chair for several hours', no: 'Sitte i en stol i flere timer' } },
      { id: 'qbpds7', text: { en: 'Climb one flight of stairs', no: 'Gå opp en etasje i trappen' } },
      { id: 'qbpds8', text: { en: 'Walk a few blocks (300-400 m)', no: 'Gå noen kvartaler (300-400 m)' } },
      { id: 'qbpds9', text: { en: 'Walk several kilometers', no: 'Gå flere kilometer' } },
      { id: 'qbpds10', text: { en: 'Reach up to high shelves', no: 'Strekke seg opp til høye hyller' } },
      { id: 'qbpds11', text: { en: 'Throw a ball', no: 'Kaste en ball' } },
      { id: 'qbpds12', text: { en: 'Run one block (about 100 m)', no: 'Løpe en blokk (ca. 100 m)' } },
      { id: 'qbpds13', text: { en: 'Take food out of the refrigerator', no: 'Ta mat ut av kjøleskapet' } },
      { id: 'qbpds14', text: { en: 'Make your bed', no: 'Re opp sengen' } },
      { id: 'qbpds15', text: { en: 'Put on socks (or pantyhose)', no: 'Ta på sokker (eller strømpebukse)' } },
      { id: 'qbpds16', text: { en: 'Bend over to clean the bathtub', no: 'Bøye seg for å rengjøre badekaret' } },
      { id: 'qbpds17', text: { en: 'Move a chair', no: 'Flytte en stol' } },
      { id: 'qbpds18', text: { en: 'Pull or push heavy doors', no: 'Dra eller skyve tunge dører' } },
      { id: 'qbpds19', text: { en: 'Carry two bags of groceries', no: 'Bære to handleposer' } },
      { id: 'qbpds20', text: { en: 'Lift and carry a heavy suitcase', no: 'Løfte og bære en tung koffert' } },
    ],
    options: [
...
export function calculateDASHScore(answers) {
  ...
  if (answeredCount < requiredItems) {
    return {
      error: true,
      message: { en: `At least ${requiredItems} items must be answered`, no: `Minst ${requiredItems} spørsmål må besvares` },
      itemsAnswered: answeredCount,
      requiredItems,
    };
  }
