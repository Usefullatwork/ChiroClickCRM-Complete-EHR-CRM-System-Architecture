...
export const QuickFeedback = ({ suggestionId, onFeedback }) => {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-sm text-gray-600 dark:text-gray-300">Var dette nyttig?</span>
      <button
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <div className="space-y-3">
            ...
            {/* Neutral categories */}
            <div>
              <span className="text-xs text-gray-600 dark:text-gray-300 font-medium">Nøytral</span>
              <div className="flex flex-wrap gap-2 mt-1">
