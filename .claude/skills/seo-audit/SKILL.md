...
1. **Fetch homepage** -- retrieve HTML via curl, fetch, or browser tool
2. **Detect business type** -- analyze homepage signals (e-commerce, SaaS, local, blog, etc.)
...
- `screenshots/` -- Desktop + mobile captures (if browser tool available)
