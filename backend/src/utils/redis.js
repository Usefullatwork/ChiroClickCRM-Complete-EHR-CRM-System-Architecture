...
class CacheService {
  ...
  async setEncounter(encounterId, data) {
    return await this.redis.set(`encounter:${encounterId}`, data, this.redis.defaultTTL.encounter);
  }
  ...
  async setMacros(orgId, data) {
    return await this.redis.set(`macros:${orgId}`, data, this.redis.defaultTTL.macro);
  }
  ...
  async setSession(sessionId, data, ttl) {
    return await this.redis.set(`session:${sessionId}`, data, ttl || this.redis.defaultTTL.session);
  }
